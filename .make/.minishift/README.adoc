...
== Let's deploy `fabric8-toggles` server in Minishift
=== Deploy the DB
...
# in https://raw.githubusercontent.com/xcoulon/fabric8-minishift/master/toggles.yml modify
# - image: registry.devshift.net/fabric8-services/fabric8-toggles:latest
# - image: 172.30.1.1:5000/fabric8/fabric8-toggles:latest
kedge apply -f toggles.yml

=== Deploy KC server
In `fabric8-minishift`:
`make deploy-kc`
